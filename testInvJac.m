...
[pt2d_err, d_uv_d_pt3d_err, d_uv_d_param_err] = project(X_(1),X_(2), X_(3),fx,fy,cx,cy,k1,k2,k3,k4,k5,k6,p1,p2,s1,s2,s3,s4,s5,s6,t1,t2, alpha, beta, rx, ry, rz);
[pt2d_err1, d_uv_d_pt3d_err1, d_uv_d_param_err1] = project(X_(1)+disturbance_pt3d(1),X_(2)+disturbance_pt3d(2), X_(3)+disturbance_pt3d(3), fx0,fy0,cx0,cy0,k10,k20,k30,k40,k50,k60,p10,p20,s10,s20,s30,s40,s50,s60,t10,t20, alpha0, beta0, rx0, ry0, rz0);
...
[pt3d_err, d_pt3d_d_uv_err, d_pt3d_d_param_err] = unproject(pt2d(1),pt2d(2), fx,fy,cx,cy,k1,k2,k3,k4,k5,k6,p1,p2,s1,s2,s3,s4,s5,s6,t1,t2, alpha, beta, rx, ry, rz);
[pt3d_err2, d_pt3d_d_uv_err2, d_pt3d_d_param_err2] = unproject(pt2d(1)+disturbance_pt2d(1),pt2d(2)+disturbance_pt2d(2), fx0,fy0,cx0,cy0,k10,k20,k30,k40,k50,k60,p10,p20,s10,s20,s30,s40,s50,s60,t10,t20, alpha0, beta0, rx0, ry0, rz0);
...
[pt2d_all_err1, d_uv_d_pt3d_all_err1, d_uv_d_param_all_err1] = project(X_(1)+disturbance_pt3d(1),X_(2)+disturbance_pt3d(2), X_(3)+disturbance_pt3d(3), fx,fy,cx,cy,k1,k2,k3,k4,k5,k6,p1,p2,s1,s2,s3,s4,s5,s6,t1,t2, alpha, beta, rx, ry, rz);
...
[pt3d_all_err2, d_pt3d_d_uv_all_err2, d_pt3d_d_param_all_err2] = unproject(pt2d(1)+disturbance_pt2d(1),pt2d(2)+disturbance_pt2d(2), fx,fy,cx,cy,k1,k2,k3,k4,k5,k6,p1,p2,s1,s2,s3,s4,s5,s6,t1,t2, alpha, beta, rx, ry, rz);
...
[xMat, yMat] = meshgrid(1:10: 3280, 1:10: 2464);
pix = [xMat(:) yMat(:)];
cov_2d = zeros(2,2,size(pix,1));
cov_3d = zeros(3,3,size(pix,1));
for i = 1 : size(pix,1)
    [pt3d_i, d_pt3d_d_uv_i, d_pt3d_d_param_i] = unproject(pix(i,1),pix(i,2), fx0,fy0,cx0,cy0,k10,k20,k30,k40,k50,k60,p10,p20,s10,s20,s30,s40,s50,s60,t10,t20, alpha0, beta0, rx0, ry0, rz0);
    [pt2d, d_uv_d_pt3d, d_uv_d_param] = project(pt3d_i(1),pt3d_i(2), pt3d_i(3),fx0,fy0,cx0,cy0,k10,k20,k30,k40,k50,k60,p10,p20,s10,s20,s30,s40,s50,s60,t10,t20, alpha0, beta0, rx0, ry0, rz0);
